...
class VideoRecorder:
    ...
    @classmethod
    def create_like(cls, videorecorder_to_copy):
        return cls(
            fps=videorecorder_to_copy.fps,
            codec=videorecorder_to_copy.codec,
            input_pix_fmt=videorecorder_to_copy.input_pix_fmt,
            **videorecorder_to_copy.kwargs
        )
